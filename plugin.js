(function() {
    ...
    function filmixApi(component, _object) {
        ...
        this.searchByTitle = function(_object, query) {
            ...
            network.clear();
            network.silent(proxy_url + url, function(json) {
        ...
        // --- ИЗМЕНЕННАЯ ФУНКЦИЯ getFile (из online_mod.js) ---
    ...
    function component(object) {
        ...
        this.similars = function(json) {
            ...
            json.forEach(function(elem) {
                ...
                if (elem.countries && elem.countries.length) info.push((elem.filmId ? elem.countries.map(function(c) {
                    return c.country;
                }) : elem.countries).join(', '));
