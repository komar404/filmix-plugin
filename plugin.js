(function() {
    ...
    function getVideoProxy() {
        return VIDEO_PROXIES[Math.floor(Math.random() * VIDEO_PROXIES.length)];
    }
    ...
    function filmixApi(component, _object) {
        ...
        // --- ВСПОМОГАТЕЛЬНЫЕ ФУНКЦИИ ДЛЯ ВИДЕО (из online_mod.js) ---
        this.getDefaultQuality = function(qualityMap, url) {
            ...
            // Если нет выбранного качества, берем максимальное
        ...
        // --- ИСПРАВЛЕННАЯ ФУНКЦИЯ ПОЛУЧЕНИЯ ВИДЕО ---
        ...
        // --- ИСПРАВЛЕННАЯ ФУНКЦИЯ ЗАПУСКА ПЛЕЕРА ---
        function append(items) {
            ...
            component.draw(items, {
                ...
                onEnter: function onEnter(item, html) {
                    ...
                    if (extra.file) {
                        // Получаем URL видео через прокси
                        ...
                        var first = {
                            ...
                            title: item.title,
                            // ВАЖНО: добавляем заголовки как в online_mod.js
                            headers: {
    ...
    function startPlugin() {
        ...
        console.log('[Filmix] Starting plugin v3.0.0');
