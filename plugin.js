(function() {
    ...
    // --- НАДЕЖНЫЕ ПРОКСИ (не требуют активации) ---
    var WORKING_PROXIES = [
        'https://proxy.cors.sh/',
        'https://corsproxy.io/?',
        'https://cors.eu.org/',
    ...
    function getProxyUrl() {
        ...
        var proxy = WORKING_PROXIES[index];
    ...
    function filmixApi(component, _object) {
        ...
        this.searchByTitle = function(_object, query) {
            ...
            function performSearch() {
                ...
                // Для некоторых прокси нужно кодировать полный URL
                if (proxy.includes('proxy.cors.sh') || proxy.includes('corsproxy.io')) {
        ...
        this.find = function(filmix_id) {
            ...
            function performFind() {
                ...
                network.silent(fullUrl, function(found) {
                    ...
                    console.log('[Filmix] Details failed:', error);
                    if (retry_count < max_retries) {
                        retry_count++;
                        setTimeout(performFind, 1000);
                    } else {
        ...
        function success(json) {
            ...
            console.log('[Filmix] JSON structure:', {
                has_player_links: !!json.player_links,
                player_links_keys: json.player_links ? Object.keys(json.player_links) : [],
                has_playlist: json.player_links && json.player_links.playlist ? true : false,
                has_movie: json.player_links && json.player_links.movie ? true : false
            });
        ...
        function extractData(data) {
            ...
            if (pl_links && pl_links.playlist && Object.keys(pl_links.playlist).length > 0) {
                console.log('[Filmix] Detected TV series, seasons:', Object.keys(pl_links.playlist).length);
                ...
                for (var season in pl_links.playlist) {
                    ...
                    for (var voice in episode) {
                        ...
                        for (var ID in episode_voice) {
                            ...
                            console.log('[Filmix] Episode file:', stream_url);
                ...
                console.log('[Filmix] Detected movie, translations:', pl_links.movie.length);
                ...
                for (var _ID in pl_links.movie) {
                    ...
                    console.log('[Filmix] Movie file:', _file_episod.link);
        ...
        function getFile(element, max_quality) {
            ...
            console.log('[Filmix] Final file URL:', file);
            ...
            this.getEpisodes(items[0].season, function(episodes) {
                ...
                items.forEach(function(element, index) {
                    ...
                    element.mark = function() {
                        ...
                        _this5.watched({ balanser: balanser, balanser_name: Lampa.Utils.capitalizeFirstLetter(balanser), voice_id: choice.voice_id, voice_name: choice.voice_name || element.voice_name, episode: element.episode, season: element.season });
                    };
                    ...
                    _this5.contextMenu({
                        html: html,
                        element: element,
                        onFile: function onFile(call) { if (params.onContextMenu) params.onContextMenu(element, html, data, call); },
                        onClearAllMark: function onClearAllMark() { items.forEach(function(elem) { elem.unmark(); }); },
                        onClearAllTime: function onClearAllTime() { items.forEach(function(elem) { elem.timeclear(); }); }
                    });
                    scroll.append(html);
                });
        ...
        this.contextMenu = function(params) {
            params.html.on('hover:long', function() {
                function show(extra) {
                    ...
                    if (Lampa.Account.logged() && params.element && typeof params.element.season !== 'undefined' && params.element.translate_voice) { menu.push({ title: Lampa.Lang.translate('online_voice_subscribe'), subscribe: true }); }
                    ...
                    Lampa.Select.show({
                        ...
                        onSelect: function onSelect(a) {
                            ...
                            if (a.subscribe) {
                                Lampa.Account.subscribeToTranslation({ card: object.movie, season: params.element.season, episode: params.element.translate_episode_end, voice: params.element.translate_voice }, function() { Lampa.Noty.show(Lampa.Lang.translate('online_voice_success')); }, function() { Lampa.Noty.show(Lampa.Lang.translate('online_voice_error')); });
                            }
                        }
                    });
                }
    ...
    function startPlugin() {
        ...
        console.log('[Filmix] Starting plugin v2.4.0');
